...
public class GetPropertiesByLocationAndDate extends BaseTask {
    private API.IGetRealTimeObject mCallback;

    public GetPropertiesByLocationAndDate(API api, SearchProperty query, API.IGetRealTimeObject cbGetData) {
        ...
        params.put("country", query.getCountry());
